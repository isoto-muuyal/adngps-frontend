			   ...
			   echo' </a>
                  <ul>
					...
					<form action="MODULES/INTERACTIONS/index.php" method="post"  name="a'.$id_servidor.'">
						...
						<input type="submit" value="Interacciones"  style="font-size:50px; width:100%;"  id="windoname" onClick="enviaformulario'.$id_servidor.'();"/>
 					</form>
					<br><br>		
...
//CONSULTA A LA TABLA LECTURA
$consulta2=odbc_exec($conexion,"SELECT DISTINCT id_servidor from EE_ASIGNACIONES_EXTRAS WHERE usuario='".$miEmpresa."' AND usuario_primario != '".$miEmpresa."' ORDER BY id_servidor");

//echo '<h4 style="text-align:center; background:#0b90e5; padding-top:3%; padding-bottom:3%; margin:0;">Veh&iacute;culos extras de '.$miEmpresa.'</h4>';
...
while ($datos=odbc_fetch_object($consulta_datos)) 
            ...
            <ul>
			   ...
			   echo' </a>
                  <ul>
                       <li><span class="solo_info_txt">&nbsp;</li>
                       <li><span class="solo_info_txt" style="font-weight:bold; font-size:45%;">ULTIMA CONEXI&Oacute;N : '.$ultima_posicion.'</span><br></li>
                       <li>';
...
?>
 <form action="" method="post">
                ...
                margin-bottom:5px; margin-top:5px; font-size:50px;" >
 </form>
 <br /><br />
</div> 
</body>

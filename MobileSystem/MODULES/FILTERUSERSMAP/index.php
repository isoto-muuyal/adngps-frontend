...
echo '<div id="btn_open_options_travel_filter_filter_users">Ver Lista de Vehiculos de '.$miEmpresa.'</div>
...
$consulta2=odbc_exec($conexion,"SELECT DISTINCT id_servidor from EE_ASIGNACIONES_EXTRAS WHERE usuario='".$miEmpresa."'");

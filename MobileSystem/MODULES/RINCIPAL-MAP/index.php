...
<style>
      html, body {
        ...
        margin: 0;
        padding: 0;
		background:url(img/bg_map.jpg); background-size:100%; 
      }
      #map_canvas {
        height: 75%;
      }
...
echo '<div id="btn_open_options_travel_filter_filter_users">Estatus de Veh&iacute;culos</div>
<div id="cerrar_opciones_recorrido_con_filtro_vehiculo">CERRAR</div>';
...
$consulta2=odbc_exec($conexion,"SELECT DISTINCT id_servidor from EE_ASIGNACIONES_EXTRAS WHERE usuario='".$_SESSION['MM_Username']."'");

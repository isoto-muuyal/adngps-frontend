			...
			<table border="0" class="miTABLE" cellpadding="10" cellspacing="10">';
			 ...
			 echo '
				...
				<tr class="miTR">
					...
					<td class="miTD" valign="medli" style="color:red;">';?>
					<a href="MODULES/USERS/multiusers.php?usid=<?php echo $inventarios->id?>" target="_blank" onClick="window.open(this.href, this.target, 'width=300,height=530'); return false;" class="eliminacion" style="display:block; width:100%;text-align:center;text-decoration:none; font-size:13px;">&nbsp;&nbsp;Agregar Padres&nbsp;&nbsp;</a>	

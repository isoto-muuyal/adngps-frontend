			 ...
			 echo '
				...
				<tr class="miTR">
					...
					<td class="miTD">
						...
						<input name="nombre_usuario_boofer" type="hidden" value="'.$inventarios->nombre_usuario.'" />
				  ...
				  <tr>
					...
					<td class="miTD">';?>
						...
						<a href="MODULES/DEVICES/multidesignations.php?vhi=<?php echo $inventarios->id?>" target="_blank" onClick="window.open(this.href, this.target, 'width=300,height=530'); return false;" class="eliminacion" style="display:block; width:100%;text-align:center;text-decoration:none; font-size:12px;">&nbsp;&nbsp;Asignaciones&nbsp;&nbsp;</a>	

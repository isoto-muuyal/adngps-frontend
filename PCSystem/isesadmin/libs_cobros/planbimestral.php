			...
			if ($periodo==6) {
				...
				<table width="100%" border="1" bordercolor="e2e2e2" cellpadding="0" cellspacing="0" style="color:#fff">
					  ...
					  <td width="7%">';
					  		 ...
					  		 //PROXIMO PAGO 2
						     $proximo_pago2 = strtotime ( '+2 month' , strtotime ( $fechaFacturacion ) ) ;
							 $proximo_pago2 = date ( 'Y-m-d' , $proximo_pago2 );
							 
							 if ($proximo_pago2==$proximo_pago) {echo '<span class="aviso_prox_pago">'.$proximo_pago2.'</span>';}
							 else {echo $proximo_pago2;}
							 echo '<br>$'.$micosto.'.00';
							 //PROXIMO PAGO 2
					  ...
					  <td width="7%">';
					  		 ...
					  		 //PROXIMO PAGO 4
						     $proximo_pago4 = strtotime ( '+4 month' , strtotime ( $fechaFacturacion ) ) ;
							 $proximo_pago4 = date ( 'Y-m-d' , $proximo_pago4 );
							 
							 if ($proximo_pago4==$proximo_pago) {echo '<span class="aviso_prox_pago">'.$proximo_pago4.'</span>';}
							 else {echo $proximo_pago4;}
							 echo '<br>$'.$micosto.'.00';
							 //PROXIMO PAGO 4
					  ...
					  <td width="7%">';
					  		 ...
					  		 //PROXIMO PAGO 8
						     $proximo_pago8 = strtotime ( '+8 month' , strtotime ( $fechaFacturacion ) ) ;
							 $proximo_pago8 = date ( 'Y-m-d' , $proximo_pago8 );
							 if ($proximo_pago8==$proximo_pago) {echo '<span class="aviso_prox_pago">'.$proximo_pago8.'</span>';}
							 else {echo $proximo_pago8;}
							 echo '<br>$'.$micosto.'.00';
							 //PROXIMO PAGO 8
					  ...
					  <td width="7%">';
					  		 ...
					  		 //PROXIMO PAGO 10
						     $proximo_pago10 = strtotime ( '+10 month' , strtotime ( $fechaFacturacion ) ) ;
							 $proximo_pago10 = date ( 'Y-m-d' , $proximo_pago10 );
							 if ($proximo_pago10==$proximo_pago) {echo '<span class="aviso_prox_pago">'.$proximo_pago10.'</span>';}
							 else {echo $proximo_pago10;}
							 echo '<br>$'.$micosto.'.00';
							 //PROXIMO PAGO 10
					  ...
					  <td bgcolor="#f1f1f1">'; $totalPlan=$micosto * 6; echo 'Total Plan : <br><span style="color:red; font-weight:bold;">$'.$totalPlan.'.00</span>'; echo '</td>
					  </tr>

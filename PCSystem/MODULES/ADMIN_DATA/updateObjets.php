<?php 
		...
		//PRIMER PASO RECEPCION DE DATOS FUNCION MODIFICAR
					...
					$boofer_name_principal_user=$_POST['boofer_name_principal_user'];
        ...
        <?php echo '
                 <div id="funcion_opacidad">
                    ...
                    <form action="panel.php" method="post">
						...
						<input name="boofer_name_principal_user" type="hidden" value="'.$boofer_name_principal_user.'" />
		...
		?>
			...
			if (isset($_POST['confirmacion'])) {
					...
					odbc_exec($conexion, "UPDATE EE_ASIGNACIONES_EXTRAS SET  usuario = '".$select_user."', usuario_primario = '".$select_user."' WHERE id_servidor='".$id."' AND usuario = '".$boofer_name_principal_user."' AND usuario_primario = '".$boofer_name_principal_user."';"); 
					//ACTUALIZACION DEl INVENTARIO ASIGNACIIONES EXTRAS

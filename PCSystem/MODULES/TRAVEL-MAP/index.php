...
$consulta2=odbc_exec($conexion,"SELECT top 900 * FROM ZLECTURAS WHERE id_servidor='".$nuestro_id."' AND hora_servidor BETWEEN '".$cadena_fecha_inicio."' AND '".$cadena_fecha_temno."' ORDER BY hora_servidor DESC  ");

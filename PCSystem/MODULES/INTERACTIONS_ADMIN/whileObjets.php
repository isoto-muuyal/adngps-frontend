...
<body>
    ...
    <?php  
			...
			if (!isset($_POST['filtro'])) {
				...
				echo '<h3>'.$numObjetsArray['counter'].' Dispositivos Totales en el Sistema</h3><br>';
	...
	$sentence="SELECT * FROM E_INVENTARIO_GENERAL WHERE nombre_usuario='".$filtro."'";
	$num_objets = odbc_exec($conexion, "SELECT Count(*) AS counter FROM E_INVENTARIO_GENERAL WHERE nombre_usuario ='".$filtro."' ");
    $numObjetsArray = odbc_fetch_array($num_objets);
	$numObjetsArray['counter'];
	echo '<h3>'.$numObjetsArray['counter'].' Dispositivos para : "'.$filtro.'"</h3>';
			...
			if ($o5=='ok') {$f5='checked="checked"';} else {$f5='';}
			 ...
			 echo '
			      ...
			      <tr class="miTR">
					...
					<td class="miTDtitle" align="center">'.$inventarios->nombre_vehiculo.'</td>
				  </tr>

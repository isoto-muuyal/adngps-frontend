...
<html>
 ...
 color:#fff;
  ...
  <body>
	...
	$consulta=odbc_exec($conexion,"SELECT * FROM ZLECTURAS WHERE id_servidor='".$id_vehiculo."' AND hora_servidor BETWEEN '".$cadena_fecha_inicio."' AND '".$cadena_fecha_temno."' ORDER BY id DESC ");
...
$consulta=odbc_exec($conexion,"SELECT * FROM ZLECTURAS WHERE id_servidor='".$id_vehiculo."' AND hora_servidor BETWEEN '".$cadena_fecha_inicio."' AND '".$cadena_fecha_temno."' ORDER BY id ASC ");
 ...
 var flightPath = new google.maps.Polyline({
  ...
  for(var i in flightPlanCoordinates){
	...
	$consulta_ultima_posicion_para_marcador=odbc_exec($conexion,"SELECT * FROM ZLECTURAS WHERE id_servidor='".$id_vehiculo."' AND hora_servidor BETWEEN '".$cadena_fecha_inicio."' AND '".$cadena_fecha_temno."' ORDER BY id ASC ");
	...
	$consulta_ultima_posicion_para_marcador=odbc_exec($conexion,"SELECT * FROM ZLECTURAS WHERE id_servidor='".$id_vehiculo."' AND hora_servidor BETWEEN '".$cadena_fecha_inicio."' AND '".$cadena_fecha_temno."' ORDER BY id DESC ");
